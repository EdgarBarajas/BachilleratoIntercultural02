...
if (!empty($_GET['id_materia']) && !empty($_GET['id_docente'])) {
  
  $id_materia = $_GET['id_materia'];
  $id_docente = $_GET['id_docente'];

  $rdeletemateria = $mysqli->query("DELETE FROM `materias` WHERE id='$id_materia'");
  if ($rdeletemateria) {
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
            <p>Materia Eliminada Correctamente</p>
          </div>
    ...
    <div class="modal fade" id="modalSuccess" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
            <p>Error al eliminar la materia</p>
          </div>
          <div class="modal-footer m-auto"> 
            <a href="../detalles-docente.php?id_docente='.$id_docente.'">
              <button type="button" class="btn btn-primary bg-orange">Continuar</button> 
    ...
    <div class="modal fade" id="modalSuccess" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
            <p>Error al recibir los datos de la materia a eliminar</p>
          </div>
          <div class="modal-footer m-auto"> 
            <a href="../detalles-docente.php?id_docente='.$id_docente.'">
              <button type="button" class="btn btn-primary bg-orange">Continuar</button> 
