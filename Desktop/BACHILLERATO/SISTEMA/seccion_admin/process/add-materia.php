...
if (!empty($_POST['materia']) && !empty($_POST['semestre']) && !empty($_POST['correo_docente']) && !empty($_POST['id_docente'])) {
  ...
  $raddmateria = $mysqli->query("INSERT INTO `materias`(`correo_docente`, `materia`, `semestre`) VALUES ('$correo_docente','$materia','$semestre')");
  if ($raddmateria) {
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
            <p>Materia asignada al docente</p>
          </div>
    ...
    <div class="modal fade" id="modalSuccess" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
            <p>Error al asignar la materia al docente</p>
          </div>
          <div class="modal-footer m-auto"> 
            <a href="../detalles-docente.php?id_docente='.$id_docente.'">
              <button type="button" class="btn btn-primary bg-orange">Continuar</button> 
