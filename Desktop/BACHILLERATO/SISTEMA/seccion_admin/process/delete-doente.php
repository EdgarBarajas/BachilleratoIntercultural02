...
if (!empty($_GET['id_docente'])) {
  ...
  $rdeletemateria = $mysqli->query("DELETE FROM `docentes` WHERE id_docente='$id_docente'");
  if ($rdeletemateria) {
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
            <p>Docente Eliminado Correctamente</p>
          </div>
    ...
    <div class="modal fade" id="modalSuccess" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
            <p>Error al eliminar al docente</p>
          </div>
          <div class="modal-footer m-auto"> 
            <a href="../maestros.php">
              <button type="button" class="btn btn-primary bg-orange">Continuar</button> 
    ...
    <div class="modal fade" id="modalSuccess" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
            <p>Error al recibir los datos del docente a eliminar</p>
          </div>
          <div class="modal-footer m-auto"> 
            <a href="../maestros.php">
              <button type="button" class="btn btn-primary bg-orange">Continuar</button> 
